...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsCableToolbarCableToolbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function CableToolbarComponent(googleApiService) {
        ...
        value: function showCable(index) {
          ...
          if (this.chosenCable && this.chosenCable.index === index) {
            ...
            cable.landingPoints.forEach(function (lp) {
              var marker = _this.googleApiService.addMarker(lp.coordinates, lp);
    ...
    function () {
      function MarkerSnackbarComponent(googleApiService) {
        ...
        this.googleApiService.getSnackSub().subscribe(function (data) {
          _this2.currSnackData = data;
          _this2.lastInited = Date.now();
          _this2.showSnack = true;
          setTimeout(function () {
            if (Date.now() - _this2.lastInited >= 5000) {
              _this2.showSnack = false;
              setTimeout(function () {
                _this2.currSnackData = null;
              }, 1000);
            }
          }, 5000);
        });
  ...
  function srcAppServicesGoogleApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(GoogleApiService, [{
        ...
        key: "addMarker",
        value: function addMarker(position, markerData) {
          var _this3 = this;
        ...
        value: function drayLine(markers) {
          ...
          setTimeout(function () {
            return _this5.map.fitBounds(_this5.markerBounds);
          }, 1000);
        }
      }, {
        key: "removeLine",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Misha\Google Drive\סמי שמעון\שנה ד\סמסטר א\סייבר מרחבי\תרגיל 2\the web project\IOT-webGIS\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
